package ma.emsi.essalmani.appwebclient.services;
...
public class EtudiantWebClient {
    private final WebClient webClient = WebClient.create("http://localhost:8093/");
    private static final String BASE_URL = "http://localhost:8093/etudiants";
