package ma.emsi.essalmani.appresttemplate.services;
...
private final RestTemplate restTemplate = new RestTemplate();
    ...
    private final String BASE_URL = "http://localhost:8093/students";
    private static final String BASE_URL2 = "http://localhost:8093/students/search/findEtudiantByNom?n={nom}";
